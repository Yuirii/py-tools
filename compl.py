...
class Pyqt5_Serial(QtWidgets.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.setupUi(self)
        self.init()
        self.setWindowTitle("Yoole's COMhelper")
    ...
    def data_receive(self):
        ...
        if num > 0:
            ...
            # # self.s2__receive_text.insertPlainText(out_len)
            # # self.s2__receive_text.insertPlainText(out_adds)
            # # self.s2__receive_text.insertPlainText(out_advd)
